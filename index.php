...
<head>
  ...
  <title>Kpopshops - Store Kpop</title>
...
<body id="app">
  ...
  <section id="popup" class="popup">
    <div class="wrapperPopoUp">
      <form action="form.php" method="POST" class="form" id="contact-form">
    ...
    <div class="wrapperPhone">
      <div class="burguer">
        ...
        <ul class="menu">
          ...
          <li>
            <a href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0">Blackpink Merch
              <span class="material-icons md-light arrow">expand_more</span></a>
          </li>
          <li>
            <a href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0">Stray Kids Shop</a>
          </li>
          ...
          <li>
            <a href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0">BTS Shop<span class="material-icons md-light arrow">expand_more</span></a>
          </li>
          <li>
            <a href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0">K-POP Albums</a>
          </li>
          <li>
            <a href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0">MORE K-POP GROUPS</a>
          </li>
          <li>
            <a href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0">Discover Kpopshop</a>
          </li>
          <li>
            <a href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0">Anime Shop</a>
          </li>
      ...
      <div class="logoPhone">
        <img src="./assets/images/LOGO-KS5.png" alt="" />
      </div>
      <div class="cart">
        <svg aria-hidden="true" focusable="false" role="presentation" width="28" height="26" viewBox="0 10 28 26" xmlns="http://www.w3.org/2000/svg">
          <path fill="currentColor" fill-rule="evenodd" d="M26.15 14.488L6.977 13.59l-.666-2.661C6.159 10.37 5.704 10 5.127 10H1.213C.547 10 0 10.558 0 11.238c0 .68.547 1.238 1.213 1.238h2.974l3.337 13.249-.82 3.465c-.092.371 0 .774.212 1.053.243.31.576.465.94.465H22.72c.667 0 1.214-.558 1.214-1.239 0-.68-.547-1.238-1.214-1.238H9.434l.333-1.423 12.135-.589c.455-.03.85-.31 1.032-.712l4.247-9.286c.181-.34.151-.774-.06-1.144-.212-.34-.577-.589-.97-.589zM22.297 36c-1.256 0-2.275-1.04-2.275-2.321 0-1.282 1.019-2.322 2.275-2.322s2.275 1.04 2.275 2.322c0 1.281-1.02 2.321-2.275 2.321zM10.92 33.679C10.92 34.96 9.9 36 8.646 36 7.39 36 6.37 34.96 6.37 33.679c0-1.282 1.019-2.322 2.275-2.322s2.275 1.04 2.275 2.322z"></path>
  ...
  <footer>
    <div class="footer container">
      ...
      <a href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0">
        <div>
          <h4>More</h4>
          <p>COVID-19 PREVENTION POLICY PAGE</p>
          <p>Be Our Ambassador</p>
        </div>
      </a>
      <a href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0">
        <div>
        ...
        <div>
          ...
          <div class="site-footer-block-content">
            <div class="social-icons">
              <a class="social-link" title="Facebook" href="https://www.facebook.com/kpopshopofficial" target="_blank">
              ...
              <a class="social-link" title="Pinterest" href="https://www.pinterest.com/kpopshop_com" target="_blank">
                <svg aria-hidden="true" focusable="false" role="presentation" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
              ...
              <a class="social-link" title="Instagram" href="https://www.instagram.com/kpopshop_com" target="_blank">
                <svg aria-hidden="true" focusable="false" role="presentation" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
              ...
              <a class="social-link" title="E-mail" href="mailto:support@kpopshop.com" target="_blank">
                <svg aria-hidden="true" focusable="false" role="presentation" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
    ...
    <div class="footerOut container">
      <div class="site-footer-item">
        <nav class="site-footer-navigation" aria-label="Footer">
          <ul class="navmenu navmenu-depth-1" data-navmenu="">
            <li class="navmenu-item navmenu-id-covid-19-prevention-policy-page">
              <a class="navmenu-link" href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0">
                COVID-19 Prevention Policy Page
              </a>
            </li>

            <li class="navmenu-item navmenu-id-why-shopping-from-kpopshop">
              <a class="navmenu-link" href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0">
                Why Shopping From Kpopshop ?
              </a>
            </li>
            ...
            <li class="navmenu-item navmenu-id-faq">
              <a class="navmenu-link" href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0"> FAQ </a>
            </li>
            ...
            <li class="navmenu-item navmenu-id-about-us">
              <a class="navmenu-link" href="https://kpopshop.com?sca_ref=865377.vBFbY4DKS0"> About us </a>
            </li>
          </ul>
        </nav>

        <p class="site-footer-credits">Copyright © 2021 Kpopshops.</p>
      </div>
      <div class="siteFooterItem">
        ...
        <ul class="payment-icons">
          ...
          <li class="payment-icons-item">
            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24" width="38" height="24" aria-labelledby="pi-pay">
              <title id="pi-pay">Shop Pay</title>
